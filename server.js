...
app.use(cors({
  origin: ['https://paycst11.netlify.app', 'http://localhost:12194', 'http://localhost:3000', 'https://taupe-duckanoo-4f033e.netlify.app', 'http://localhost:39267', 'https://paycst.netlify.app'],
}));
